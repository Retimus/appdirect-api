...
public class SubscriptionTestController {
    ...
    public String createSubscriptionCreateEvent() throws JAXBException, IOException {
        Resource resource = context.getResource("classpath:SubscriptionCreateEvent.xml");
